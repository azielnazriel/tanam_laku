        ...
        <div class=" container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item me-4"><a class="nav-link" id="ketik" href="#!">Jual</a></li>
            ...
            <script>
                ...
                <form class="d-flex">
                    <button class="btn btn-outline-success " type="submit">
                        ...
                        Suka
                        <span class="badge bg-success text-white ms-1 me-2 rounded-pill">0</span>
                    </button>
                </form>
                ...
                <form>
                    <div class="row">
                        <li class="col-4 ketik list-unstyled" href="#!">Masuk</i>
                        <li class="col-4 offset-4 ketik list-unstyled" href="#!">Daftar</i>
                    </div>
                </form>
            </div>
        </div>
